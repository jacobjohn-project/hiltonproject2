...
public class BarcodeSearchActivity extends AppCompatActivity {
    ...
    TextView txtPartName,txtRecDate,txtMovDate,txtSignBy;
    EditText etSearch;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fromActivity= getIntent().getStringExtra(Constants.EXTRA_FROM_ACTIVITY);
    ...
    public void checkDb(String scanCode) {
        ...
        if(fromActivity.equals(Constants.FROM_MATERIAL_ISSUE_MENU)){
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.getChildrenCount() > 0) {
                        for (DataSnapshot post : dataSnapshot.getChildren()) {
                            ...
                            JobCompletionDetails productTable =  post.getValue(JobCompletionDetails.class);

                            txtPartName.setText(productTable.getJob_Num());
                            txtRecDate.setText(productTable.getQty_completed()+"");
                            txtMovDate.setText(productTable.saved_date);
//                            txtLocFrom.setText(productTable.PO_Loc_from);
//                            txtLocTo.setText(productTable.PO_Loc_to);
                            txtSignBy.setText(productTable.getWho());


                            Picasso.get().load(productTable.job_image).placeholder(R.drawable.img_placeholder).into(imgProduct ,new com.squareup.picasso.Callback() {
                                @Override
